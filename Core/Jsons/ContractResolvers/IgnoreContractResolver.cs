...
namespace TripleSix.Core.Jsons
{
    ...
    public class IgnoreContractResolver : BaseContractResolver
    {
        ...
        {
            _ignoreProps = new HashSet<string>(propertyNamesToIgnore, StringComparer.OrdinalIgnoreCase);
        }
        ...
        protected override JsonProperty CreateProperty(MemberInfo member, MemberSerialization memberSerialization)
        {
            ...
            if (property.PropertyName.IsNotNullOrEmpty() && _ignoreProps.Contains(property.PropertyName))
